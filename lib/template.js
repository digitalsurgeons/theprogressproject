                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tr>
                          <td valign="top" class="bodyContent"
                            ...
                            We understand your biggest challenge is ${params.answers[6].text}.
                            <br /><br />
                            Organization: ${params.answers[3].text}<br />
                            Business model: ${params.answers[4].choice.label}<br />
                            Role: ${params.answers[5].choice.label}<br /><br />
                        ...
                        <tr>
                          <td valign="top" class="bodyContent"
                            ...
                            <ul>
                              <li>${params.answers[7].text}</li>
                              <li>${params.answers[10].text}</li>
                              <li>${params.answers[13].text}</li>
                              <li>${params.answers[16].text}</li>
                              <li>${params.answers[19].text}</li>
                            </ul>
                          </td>
                        </tr>
                      </table>
