                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tr>
                          <td valign="top" class="bodyContent"
                            ...
                            We understand your biggest challenge is ${params.answers[5].text}.
                            <br /><br />
                            Business model: ${params.answers[3].choice.label}<br />
                            Role: ${params.answers[4].choice.label}<br /><br />
                        ...
                        <tr>
                          <td valign="top" class="bodyContent"
                            ...
                            <ul>
                              ...
                              <li>${params.answers[15].text}</li>
                              <li>${params.answers[18].text}</li>
                            </ul>
                          </td>
                        </tr>
                      </table>
