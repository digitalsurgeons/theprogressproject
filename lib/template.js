                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tr>
                          <td valign="top" class="headerContent">
                            <img
                              src="https://storage.googleapis.com/progress-project-b95ff.appspot.com/email/tpp-email-header.jpg"
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tr>
                          <td valign="top" class="bodyContent"
                            ...
                            <br /><br />
                            One of our favorite exercises to help teams prioritize, in 
                            order to hit their goals and objectives, is a simple 
                            Effort/Impact analysis. Below is the output of that exercise 
                            using what you shared with us:<br /><br />
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td valign="top" class="bodyContent"
                            ...
                            <ul type="A" style="padding-left: 17px; margin-top: 20px;">
                              ${Object.keys(params.answers.tactics)
                                .map(function (key) {
                                  return `
                                    <li>
                                      <strong style="font-weight: bold;">
                                      ...
                                      ${params.answers.tactics[key].label}
                                    </li>
                                  `
                                })
                                .join('')}
                            ...
                            link below:
                            <br /><br />
                            <a href="https://ds.link/2I2JXBg">
                              <img src="https://storage.googleapis.com/progress-project-b95ff.appspot.com/email/tpp-email-btn.png" />
                            </a>
                            <br /><br /><br />
                                      ...
                                      <table border="0" cellpadding="20" cellspacing="0"
                                        ...
                                        <tr>
                                          <td class="leftColumnContent">
                                            <a href="${reccos[key].url}"><img
                                              src="${reccos[key].image}"
                                              style="max-width:260px;"
                                              class="columnImage"
                                              mc:label="left_column_image"
                                              mc:edit="left_column_image" /></a>
                                            <p style="margin-top: 15px;"><strong>${reccos[key].heading}</strong></p>
                                            ${reccos[key].description}
                                            <br /><br />
                                            <a href="${reccos[key].url}" style="color: #EB4102;">Read more</a>
                                          </td>
                                        </tr>
                                      </table>
                                    </td>`
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tr>
                          <td valign="top" style="background: #232323;">
                            <img
                              src="https://storage.googleapis.com/progress-project-b95ff.appspot.com/email/tpp-email-footer.jpg"
