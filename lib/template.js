                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tr>
                          <td valign="top" class="bodyContent"
                            ...
                            <h1>Hey ${params.answers[0].text},</h1>
                            ...
                            <strong style="font-weight: bold;">${params.answers[6].text}</strong>
                            <br /><br />
