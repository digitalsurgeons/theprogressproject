                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tr>
                          <td valign="top" class="bodyContent"
                            ...
                            We understand your biggest challenge is $***REMOVED***params.answers[6].text***REMOVED***.
                            <br /><br />
                            Organization: $***REMOVED***params.answers[3].text***REMOVED***<br />
                            Business model: $***REMOVED***params.answers[4].choice.label***REMOVED***<br />
                            Role: $***REMOVED***params.answers[5].choice.label***REMOVED***<br /><br />
                        ...
                        <tr>
                          <td valign="top" class="bodyContent"
                            ...
                            <ul>
                              ...
                              <li>$***REMOVED***params.answers[19].text***REMOVED***</li>
                            </ul>
                          </td>
                        </tr>
                      </table>
