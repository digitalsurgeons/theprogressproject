                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tr>
                          <td valign="top" class="bodyContent"
                            ...
                            <strong style="font-weight: bold;">$***REMOVED***params.answers[6].text***REMOVED***</strong>
                            <br /><br />
                            ...
                            output of
                            what you shared with us using that exercise:
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td valign="top" class="bodyContent"
                            ...
                            <ul style="padding-left: 17px; margin-top: 0;">
                              <li><strong style="font-weight: bold;">A:</strong>
                                $***REMOVED***params.answers[7].text***REMOVED***</li>
                              <li><strong style="font-weight: bold;">B:</strong>
                                $***REMOVED***params.answers[10].text***REMOVED***</li>
                              <li><strong style="font-weight: bold;">C:</strong>
                                $***REMOVED***params.answers[13].text***REMOVED***</li>
                              <li><strong style="font-weight: bold;">D:</strong>
                                $***REMOVED***params.answers[16].text***REMOVED***</li>
                              <li><strong style="font-weight: bold;">E:</strong>
                                $***REMOVED***params.answers[19].text***REMOVED***</li>
                            </ul><br />
                            ...
                            link below:
                            <br /><br />
                            <a href="#">Book your free 30 minute consultation</a>
                            <br /><br />
                                  ...
                                  <table border="0" cellpadding="20" cellspacing="0"
                                    ...
                                    <tr>
                                      <td valign="top" class="leftColumnContent"
                                        ...
                                        <p style="margin-top: 0;"><strong>Repeatable Content</strong></p>
                                        <a
                                          href="http://kb.mailchimp.com/article/how-do-i-work-with-repeatable-content-blocks"
                                          target="_blank">Repeatable sections</a>
                                        are
                                        noted with plus and minus signs so that you
                                        can
                                        add and subtract content blocks.
                                        <br />
                                        <br />
                                        You can also get a little fancy; repeat
                                        blocks and
                                        remove all text to make image galleries, or
                                        do the
                                        opposite and remove images for text-only
                                        blocks.
                                      </td>
                                    </tr>
                                  </table>
