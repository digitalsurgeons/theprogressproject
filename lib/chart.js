  ...
  ***REMOVED***
  ...
  const tactics = [
    ***REMOVED***
      ...
      impact: answers[8].number,
      effort: answers[9].number
    ***REMOVED***,
    ***REMOVED***
      label: answers[10].text,
      impact: answers[11].number,
      effort: answers[12].number
    ***REMOVED***
  ]

  // add optional tactics
  if (answers[14].number && answers[15].number) ***REMOVED***
    tactics.push(***REMOVED***
      label: answers[13].text,
      impact: answers[14].number,
      effort: answers[15].number
    ***REMOVED***)
  ***REMOVED***

  if (answers[17].number && answers[18].number) ***REMOVED***
    tactics.push(***REMOVED***
      label: answers[16].text,
      impact: answers[17].number,
      effort: answers[18].number
    ***REMOVED***)
  ***REMOVED***

  if (answers[20].number && answers[21].number) ***REMOVED***
    tactics.push(***REMOVED***
      label: answers[19].text,
      impact: answers[20].number,
      effort: answers[21].number
    ***REMOVED***)
  ***REMOVED***
